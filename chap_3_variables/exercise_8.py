...
and you've somehow managed to find a bank that pays you 5% (this is a wish-fulfillment fantasy) compounded interest every year. 
...
balance = 1_000 * 1.05 * 1.05 * 1.05 * 1.05 * 1.05
print(f'{balance:.2f}')